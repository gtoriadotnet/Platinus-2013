<?php include($_SERVER["DOCUMENT_ROOT"]."/../plattestasset/offline.php");?>
<!DOCTYPE html>
<html>
    <head>
        <title>Platinus</title>
        
<link rel='stylesheet' href='/CSS/Base/CSS/FetchCSS?path=reset.css' />

        
<link rel='stylesheet' href='/CSS/Base/CSS/FetchCSS?path=main.css' />

        
<link rel='stylesheet' href='/CSS/Base/CSS/FetchCSS?path=page.css' />
...
<script type='text/javascript' src='http://js.rbxcdn.com/cf5d5c9953a0a57630113d518d3092d2.js'></script>

        
<script type='text/javascript' src='http://js.rbxcdn.com/f2b0cc7f4fd56709c2fe6b913866cd4c.js'></script>
            ...
            <div id="header-login-container">
                <div id="header-login-wrapper" class="iframe-login-signup">
	                ...
	                <div id="iFrameLogin" style="display:none" runat="server" clientidmode="Static" >
	                    <iframe class="login-frame" src="https://www.roblox.com/Login/iFrameLogin.aspx?loginRedirect=True&amp;parentUrl=http%3a%2f%2fwww.roblox.com%2fLanding%2fAnimated%2f" scrolling="no" frameborder="0"></iframe>
                    </div>
	            </div>
            </div>	
    </div>
...
<div id="Experimental" data-is-animated="False">
    <div class="Content">
            ...
            <div id="animatedBody">
                <div class="VideoContainer">
                    <object class="videoURL">
                        <param name="movie" value="http://www.youtube.com/v/97dyt7MXWpo&amp;fs=1&amp;rel=0&amp;autoplay=1"/>
                ...
                <div id="animated-wrapper" data-first-visit="True">
                    <div id="sign-up-wrapper">
                        <form method="POST" id="signup-form" action="https://www.roblox.com/landing/animated">
...
<option value="1913">1913</option>
                            ...
                            <div class="sign-up-row">
                                ...
                                <div><input type="text" id="username" name="UserName" value="" class="text-box text-box-large" tabindex="6" onblur="Roblox.AnimatedSignupFormValidator.checkUsername()" /></div>
    ...
    <div class="Footer Experimental">
        <div class="FooterContent">
            <p class="FooterParagraph">
                <a href="/Info/Privacy.aspx" ref="landingsignup-privacy"><b>Privacy Policy</b></a> &nbsp;|&nbsp; <a href="/Parents.aspx" ref="landingsignup-parents">Parents</a> &nbsp;|&nbsp; <a href="/Help/Builderman.aspx" ref="landingsignup-help">Help</a>    
            </p>
...
<script type='text/javascript' src='http://js.rbxcdn.com/b6b812a1635d1be4cd82b760b171c840.js'></script>

        
<script type='text/javascript' src='http://js.rbxcdn.com/6f8d0a642bbf8d5e5fb70dc0b1774b69.js'></script>
